            ...
            class="table-responsive" id="UsersGrid">
	   										<thead>
							                      <tr>
													...
													<th  data-field="User_type_id" data-filter-control="select" data-sortable="true">نوع المستخدم</th>
													<th  data-field="Position_id" data-filter-control="select" data-sortable="true">الوظيفة</th>
        ...
        <div class="modal-content">
		 <form data-toggle="validator" role="form" id="frm_Users">
            ...
            <div class="modal-body">
					...
					<div class="form-group"> <label for="Customer_id">رقم الهاتف :<span class="rqd">*</span> :</label><input type="text"  class="form-control" id="Phone_no" name="Phone_no" required></div>
					<div class="form-group"> <label for="Customer_id">اسم المستخدم :<span class="rqd">*</span> :</label><input type="email"  class="form-control" id="Email" name="Email" required></div>
            ...
            <div class="modal-footer">
                <button  class="btn btn-default" data-dismiss="modal">الغاء</button>
...
$(document).ready(function(e){
	...
	$('#frm_Users').on('submit',function(e){
		...
		$.post("AjaxFiles/AjaxEditUser.php",data,function(r){ 
		
		$('#UsersFormModal').modal('hide');
		  refereshTable(r);
		});
