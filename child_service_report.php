...
//require_once('RetrieveData2Javascript/retrieve_cmb_data.php');
   $sql = 'SELECT  * from  allservicesofferedreport '; 
     if($UserType!=436){
...
echo '<script> var JsChildServiceData='.json_encode($ChildServiceData).'; </script>';
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn ">
										<h2 id="CurrentScreen">تقرير الخدمات</h2>
										<p id="CurrentScreenDescription">يمكنك البحث عن جميع الخدمات المقدمة للمستفيدين مع امكانية التصفية بجميع المتغيرات.</p>
									</div>
								</div>
							</div>
            ...
            class="table-responsive" id="CaseServiceGrid">
										...
										<thead>
                                                ...
                                                <tr>
													...
													<th  data-field="ChildAddress" data-filter-control="input" data-sortable="true" data-width="15%" >العنوان</th>
													...
													<th  data-field="Service_cat" data-filter-control="select" data-sortable="true" data-width="10%">نوع الخدمة</th>
													<th   data-field="Service_giver_name" data-filter-control="select" data-sortable="true" data-width="10%" >مقدم الخدمة</th>
													<th   data-field="Created_date" data-filter-control="input" data-sortable="true" >تاريخ التقديم</th>
...
$(document).ready(function(e){
 ...
 t.bootstrapTable({ data:JsChildServiceData}); 
 	 $('#SearchPerid').on('change',function(e){
		...
		{$.post('AjaxFiles/AjaxCaseCaseServiceReportPeriodical.php',{userType:<?php echo $UserType; ?>,userId:<?php echo $UserId; ?>, FrmDate:$('#SearchFrm').val(),ToDate:$('#SearchTo').val()},function(r){
			var t=$("#CaseServiceGrid").bootstrapTable('destroy');
