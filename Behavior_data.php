...
$sql =  "SELECT ID,Title, List_type_id  FROM manylist where List_type_id in(18, 21, 23); ";
...
$(document).ready(function(e){
	...
	$('#btnSave').on('click',function(e){
		...
		$.ajax({url:"AjaxFiles/AjaxEditBehavior.php",async:false,
		data,success:function(r){ $('#BehaviorFormModal').modal('hide');
...
{
	currentRow = returnJsonBehaviorArray[index];
...
function EditBehaviorFormatter(value, row, index) {
	 return [
        '<a class="like btnEditBehavior"  title="Like" href="javascript:void(0);" onclick="EditCurrentRow('+index+')">',
