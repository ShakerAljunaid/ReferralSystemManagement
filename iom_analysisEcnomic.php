...
$ChildCaseID=$_REQUEST["Case_No"];	
    ...
    $sql = 'SELECT childId,ChildFullName,Gender,Age,childSource,CareGiverFullName,CareGiverPhoneNo,ChildAddress,caseId,ParentState,Specialist_id,Iom_analyst_id,Iom_analysis_state,
...
{
	$sql='SELECT * from iomanalysisechnomic where Case_id='.$ChildCaseID;
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tbody>
								  <tr class="odd gradeX">
                                        ...
                                        <td><p><div class="form-group"><textarea class="form-control " id="txtCaseHistory" name="txtCaseHistory" rows="3" cols="70" required></textarea><div class="help-block with-errors"></div></div></p></td>
                                    </tr>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><p><div class="form-group"><textarea class="form-control " id="txtRequiredInterbention" name="txtRequiredInterbention" rows="3" cols="70" required></textarea><div class="help-block with-errors"></div></div></p></td>
                                    </tr>
									
									   <tr class="odd gradeX">
                                        <td> ملاحظات</td>
                                      
                                        <td><p><div class="form-group"><textarea class="form-control " id="txtNotes" name="txtNotes" rows="3" cols="70" required></textarea><div class="help-block with-errors"></div></div></p></td>
                                    </tr>
 ...
 $(document).ready(function(){
	 if(JsImoAnalysisData)
	 {
		 $.each(JsImoAnalysisData,function(k,i){
			 $('#txtFamilyHist').val(i.Family_echo_bg),
			 $('#txtRequiredInterbention').val(i.required_intervention)
			 $('#txtCaseHistory').val(i.Case_history)
			  $('#txtNotes').val(i.Notes)
	 ...
	 console.log(data);
	 $.post('AjaxFiles/AjaxNewIomAnalysisEcho.php',data,function(r){
		 if(parseInt(r)>0)
	 ...
	 $('#btnPrint').on('click',function(e){
		 window.open('iom_analysisEcnomicPrint.php?Case_No='+ChildCaseID);
