...
echo '<script> var JsPendingChildrenCases2='.json_encode($ChildData).';</script>';
																		...
																		<thead>
																				<tr>
																				 <th  data-field="childId" data-filter-control="input" data-sortable="true">الرقم</th>
																					...
																					<th  data-field="AnalysisDate" data-filter-control="input" data-sortable="true"> تاريخ الإستلام</th>
																					<th  data-field="AnalysistSuggestedServices" data-filter-control="input" data-sortable="true"> الخدمات المقترحة</th>
...
<?php require_once("footer-links.php");  ?>
 ...
 $(function(){
  ...
  var m=$("#tblMdlPendingChildren").bootstrapTable('destroy');
   		m.bootstrapTable({ data:JsPendingChildrenCases2});
	$('#SearchPerid').on('change',function(e){
		...
		{$.post('AjaxFiles/AjaxCase4Analysis.php',{State:1,FrmDate:$('#SearchFrm').val(),ToDate:$('#SearchTo').val()},function(r){
			 var m=$("#tblMdlPendingChildren").bootstrapTable('destroy');
